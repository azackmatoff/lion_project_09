...
import 'package:lion_project_09/app/presentation/flutter_way/view/screens/city_screen.dart';
                  ...
                  children: <Widget>[
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        TextButton(
                          onPressed: () async {
                            bool? returnedToScreen = await Navigator.push(context, MaterialPageRoute(
                              builder: (context) {
